...
export const OperatorPortal: React.FC<OperatorPortalProps> = ({ onBack, onSubmit }) => {
    ...
    if (authStep) {
        return (
            <div className="fixed inset-0 z-[100] min-h-screen bg-slate-950/95 backdrop-blur-sm flex flex-col items-center justify-center p-4">
    ...
    return (
        <div className="fixed inset-0 z-[100] min-h-screen bg-slate-950/95 backdrop-blur-sm flex flex-col items-center justify-center p-4 overflow-y-auto">
            <div className="w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden my-auto relative">
