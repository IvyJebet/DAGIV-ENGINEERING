...
export const OperatorPortal: React.FC<OperatorPortalProps> = ({ onBack, onSubmit }) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/operator-logs`, {
                ...
                headers: { 
                    ...
                    // 👇 THIS LINE IS CRITICAL. UNCOMMENT IT.
            ...
            if (response.ok) { 
                ...
                onBack(); 
                alert("Log Submitted Successfully!"); // Optional success feedback
            } 
            else { 
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-slate-950/95 backdrop-blur-sm flex items-center justify-center p-4">
            {/* UPDATED CONTAINER: Removed overflow-hidden, added flex column and max-height */}
            <div className="w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl flex flex-col max-h-[90vh] relative">
                ...
                <div className="bg-slate-950 p-6 border-b border-slate-800 flex justify-between items-center shrink-0">
                    ...
                    <button onClick={onBack} className="text-slate-400 hover:text-white p-2 rounded-full hover:bg-slate-800 transition-colors">
                        <X size={24}/>
                    </button>
                </div>
                ...
                <div className="overflow-y-auto p-8">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="bg-slate-900 p-4 rounded-lg border border-slate-800">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input required type="time" className="w-full bg-slate-950 border border-slate-700 p-2 rounded text-white" 
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input required type="number" className="w-full bg-slate-950 border border-slate-700 p-2 rounded text-white font-bold" 
                                ...
                                <div>
                                    ...
                                    <select className="w-full bg-slate-950 border border-slate-700 p-2 rounded text-white"
                                ...
                                <div>
                                    ...
                                    <input type="number" className="w-full bg-slate-950 border border-slate-700 p-2 rounded text-white" 
                        ...
                        {/* Submit Button Section - Now part of scrollable area but distinct */}
