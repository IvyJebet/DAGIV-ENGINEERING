        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              The premier marketplace for Heavy plant machinery, Industrial plant machinery, Automotive and spare parts around the world.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/gallery" className="text-slate-400 hover:text-yellow-500 transition-colors text-sm">Project Gallery</Link></li>
            </ul>
          </div>
